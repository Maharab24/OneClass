...
import com.oneclass.backend.exception.*;
...
public class AuthService {
    ...
    // ---------- VERIFY OTP ----------
    // Called from the "enter code" screen right after registration.
    // On success, marks the account verified and logs them in (returns a JWT).
    @Transactional
