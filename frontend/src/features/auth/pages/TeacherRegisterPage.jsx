      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-2xl hover:shadow-blue-500/5 transition-shadow duration-300">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm mt-2">Create your teacher account and start teaching</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start space-x-3">
              <input
                ...
                className="mt-1 w-4 h-4 bg-slate-800 border border-white/10 rounded text-blue-500 focus:ring-blue-500 focus:ring-offset-0 focus:ring-2"
              />
